...
bool getStaticField_bool(JNIEnv *env, jclass clazz, const char *field_name);
bool getStaticField_bool(JNIEnv *env, jobject java_obj, const char *field_name);
bool setStaticField_bool(JNIEnv *env, jobject java_obj, const char *field_name, bool val);
