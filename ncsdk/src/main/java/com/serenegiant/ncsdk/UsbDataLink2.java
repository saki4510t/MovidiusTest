...
public class UsbDataLink2 extends NativeObject implements IDataLink {
	private static final boolean DEBUG = true; // set false on production
	private static final String TAG = UsbDataLink2.class.getSimpleName();
...
//	    UsbEndpoint[mAddress=1,mAttributes=2,mMaxPacketSize=512,mInterval=0]]]]
	 ...
	 */
	public UsbDataLink2(@NonNull final Context context)
		throws UnsupportedOperationException {
